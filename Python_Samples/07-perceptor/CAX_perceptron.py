...
##        print(O1)
        ...
        return O1
#-------------------------------------------------------
    def learn(self, X1,X2 , Y1,W0,Enabler,Threshold,bias,beta ):  # X -INPUT   Y Output
...
##            print("DEBUG Call: predictfull:")
            Y=self.predictverbose(X1,X2,W,Enabler,Threshold,bias)
            npY=np.array(Y)
            npW=np.array(W)
...
if __name__ == '__main__':
    ...
    if mode==2 :
        ...
        print("W_final[i]=",W , "  bias_final=", bias)
