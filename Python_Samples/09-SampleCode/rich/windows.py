...
def left_panel():
    return Panel("[bold magenta]Left Window[/bold magenta]\nThis is the left window.", title="Left")

def right_panel():
    return Panel("[bold cyan]Right Window[/bold cyan]\nThis is the right window.", title="Right")
